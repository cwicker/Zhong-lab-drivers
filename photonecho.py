...
class PhotonEcho(Spyrelet):
    ...
    def createpulses(tau, step, totaltime=1e5, voltage1=1000, voltage2=3630):

        chn1 = Arbseq_Class('chn1', 1)
        chn1.totaltime = totaltime
        chn1.widths = (1,2)
        chn1.delays = (0,tau)
        chn1.heights = (voltage1, voltage1)
        chn1.create_sequence()

        chn2 = Arbseq_Class('chn2', 2)
        chn2.totaltime = totaltime
        width = 3 + (2*tau)
        chn2.widths = (width, totaltime - width)
        chn2.delays = (0,0)
    ...
    def initialize(self):
        ...
        ch1, ch2 = createpulses(tau, step, period, voltage1, voltage2)
    ...
    def pulse_parameters(self):
        ...
        ('tau', {'type': float, 'default': 50e-6, 'units':'s'}),
